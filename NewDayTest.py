...
df_movies_ratings = df_movies.join(df_min_rating, 'MovieID', 'inner')

df_movies_ratings = df_movies_ratings.join(df_max_rating, 'MovieID', 'inner')

df_movies_ratings = df_movies_ratings.join(df_avg_rating, 'MovieID', 'inner')
...
df_movies_ratings.write.parquet('./final_datasets/min_max_avg_by_movie')

df_movies.write.parquet('./final_datasets/original_movies')

df_ratings.write.parquet('./final_datasets/original_ratings')
